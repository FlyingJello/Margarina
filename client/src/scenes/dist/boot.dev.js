...
function (_Scene) {
  ...
  function BootScene() {
    ...
    var connection = new SignalR.HubConnectionBuilder().withUrl("https://localhost:44342/game").configureLogging(SignalR.LogLevel.Information).build();
    connection.start().then(function () {
      return _this.scene.start('GameScene', {
